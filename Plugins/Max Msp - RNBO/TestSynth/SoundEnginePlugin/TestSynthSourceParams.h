...
#ifndef TestSynthSourceParams_H
#define TestSynthSourceParams_H
...
struct TestSynthRTPCParams
{
    AkReal32 fDuration;
};

struct TestSynthNonRTPCParams
{
};

struct TestSynthSourceParams
    : public AK::IAkPluginParam
{
    TestSynthSourceParams();
    TestSynthSourceParams(const TestSynthSourceParams& in_rParams);
    ...
    TestSynthRTPCParams RTPC;
    TestSynthNonRTPCParams NonRTPC;
};

#endif // TestSynthSourceParams_H
